...
int main() {
	...
	//Magnitude
	std::cout << "Magnitude: " << c3.getmagn() << " should be 5" << std::endl;
	std::cout << "Magnitude: " << c4.getmagn() << " should be 13" << std::endl;

	//Phase
	std::cout << "Phase: " << c3.getphase() << " should be 53.1301" << std::endl;
	std::cout << "Phase: " << c4.getphase() << " should be 67.3801" << std::endl;
